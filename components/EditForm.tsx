...
const EditForm = ({ employee }: { employee: Employee }) => {
  // Create a version of `updateEmployee` that automatically includes the `employee.id`
  // This way, when `UpdateEmployeeWithId` is called, it knows which employee to update.
